...
app.send_task('scrape_house_property_value', args=(1, 16)) # 香港 － 山頂

app.send_task('scrape_house_property_value', args=(1, 17)) # 香港 － 灣仔

app.send_task('scrape_house_property_value', args=(1, 18)) # 香港 － 黃竹坑
